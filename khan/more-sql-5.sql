...
INSERT INTO Marvels
  ...
  (15, "Gambit", 7, "Good", "Male", 1.88, 81, "USA", 2, 2, 2, 2, 2, 4),
  (16, "Captain America", 9, "Good", "Male", 1.88, 108, "USA", 3, 3, 2, 3, 1, 6),
  (17, "Cyclops", 10, "Good", "Male", 1.90, 88, "USA", 3, 2, 2, 2, 5, 4),
  (18, "Emma Frost", 12, "Neutral", "Female", 1.78, 65, "USA", 4, 4, 2, 5, 5, 3),
  (19, "Kitty Pryde", 13, "Good", "Female", 1.68, 50, "USA", 4, 2, 2, 3, 1, 5),
  (20, "Daredevil", 14, "Good", "Male", 1.83, 91, "USA", 3, 3, 2, 2, 4, 5),
  (21, "Punisher", 50, "Neutral", "Male", 1.85, 91, "USA", 3, 3, 2, 2, 1, 6),
  (22, "Silver Surfer", 33, "Good", "Male", 1.93, 102, "Zenn-La", 3, 7, 7, 6, 7, 2),
  (23, "Ghost Rider", 86, "Good", "Male", 1.88, 99, "USA", 2, 4, 3, 5, 4, 2),
  (24, "Venon", 78, "Neutral", "Male", 1.90, 118, "USA", 3, 4, 2, 6, 1, 4),
  (25, "Juggernaut", 76, "Neutral", "Male", 2.87, 862, "USA", 2, 7, 2, 7, 1, 4),
  (26, "Professor X", 58, "Good", "Male", 1.83, 86, "USA", 5, 2, 2, 2, 5, 3);
...
SELECT name, alignment, intelligence FROM marvels
  WHERE alignment = "Bad"
  AND intelligence > 5;
...
SELECT gender, AVG(energy_Projection) FROM marvels
  GROUP BY gender;

SELECT alignment, AVG(strength) FROM marvels
  GROUP BY alignment;

SELECT hometown, COUNT(hometown) FROM marvels
  GROUP BY hometown
  ORDER BY COUNT(hometown);

SELECT name, hometown, speed, Fighting_Skills FROM marvels
  GROUP BY name
